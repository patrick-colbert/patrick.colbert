<?php
   ...
   function getMenu($searchTerm = null) {
      ...
      if(!$searchTerm) {
         ...
         $sql ='SELECT * FROM MENU WHERE ITEMNAME LIKE "'.$searchTerm.'" OR ITEMPRICE LIKE "'.$searchTerm.'" OR RESTAURANT KEY LIKE "'.$searchTerm.'" OR COURSE LIKE "'.$searchTerm.'"';
      }
      $ret = $db->query($sql);
      $array = [];
      if(!$ret){
